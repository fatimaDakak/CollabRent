...
<div class="panel-filters">
  ...
  <form id="filter-form" onsubmit="filterAnnonce(); return false;">
    ...
    <label><input type="checkbox" name="city[]" value="Tiznit"  class="filter-checkbox"><span class="checkbox"></span> Tiznit</label>	
  </div> 
</div>
	...
	<div class="form-group">
		...
		<select class="form-control" name="commentaires" id="commentaires">
		  <option value="positifs">Commentaires positifs</option>
		  <option value="negatifs">Commentaires négatifs</option>
		</select>
	</div>
	<div class="form-group">
