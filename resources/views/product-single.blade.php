		...
		<div class="row">
			<div class="col-md-6">
				<ol class="breadcrumb">
					...
					<li><a href="{{ url('/objets/1') }}">Shop</a></li>
			...
			<div class="col-md-7">
			   ...
			   <!-- <div id="modal" class="modal">
				   ...
				   <p>8.    Le présent contrat de réservation d'objet est conclu pour une durée déterminée et prend effet à compter de la signature du Client.</p>
					...
					<br/>
					<button type="button" id="clear" class="btn btn-danger btn-sm">Clear</button> <br>
				   ...
				   <script>
					...
					document.getElementById('sig').addEventListener('touchstart', function(e) {
						e.preventDefault();
					}, false);

					document.getElementById('sig').addEventListener('mousedown', function(e) {
						e.preventDefault();
					}, false);
			   ...
			   @else
				   <a href="{{ route('login') }}" class="btn btn-main mt-20">Se connecter pour reserver</a>
			   @endauth
		   </form>
		   @endif
