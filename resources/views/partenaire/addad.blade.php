...
<label for="nbjour_min">Nombre de jour minimum pour la location de cet objet</label>
<input type="number" id="nbjour_min" name="nbjour_min" value="{{ old('nbjour_min') }}">
            ...
            <select id="ville" name="ville">
                ...
                <option  name="ville" value="tanger">Tanger</option>
                <option  name="ville" value="tetouan">Tetouan</option>
            </select>
