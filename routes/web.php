...
Route::get('/partners',[AdminController::class,'showPartners'])->name('partners');
Route::get('/addcategorie',[AdminController::class,'index'])->name('addcategorie');
Route::post('/addcategorie',[AdminController::class,'store'])->name('categories.store');
